...
<%--                                <a class="fa fa-times" href="javascript:;"></a>--%>
          ...
          <div class="panel-body">
            <c:if test="${msg!=null}">
              ...
              <form action="/modifyArticle" class="form-horizontal" method="post">
                <div class="form-group">
                  ...
                  <div class="col-md-12">
                    ...
                    <input type="text"name="title" class="form-control" value="${article.title}" id="title" required placeholder="请输入文章标题" oninput="titleInput('title','h_title',50)">
<%--                    <p id="h_title">请输入文章标题（字数限制30字）</p>--%>
                ...
                <div class="form-group">
                  ...
                  <div class="radios">
                    ...
                    <label for="radio-01" class="label_radio col-lg-4 col-sm-4">
                      <input type="radio" ${article.state=='公开'?'checked':''} value="公开" id="radio-01" name="state"> 公开
                    </label>
                    <label for="radio-02" class="label_radio col-lg-4 col-sm-4">
                      <input type="radio" ${article.state=='私密'?'checked':''} value="私密" id="radio-02" name="state"> 私密
                    </label>
                ...
                <div class="form-group">
                  ...
                  <label for="introduce" class="control-label">文章简介:</label>
                    <textarea name="introduce" rows="3" class="form-control" id="introduce" oninput="titleInput('introduce','h_introduce',100)" required placeholder="请输入文章简介">${article.introduce}</textarea>
                ...
                <div class="form-group">
                  <div class="col-md-12">
                    ...
                    <textarea class="form-control ckeditor" id="content" oninput="titleInput('content','h_content',20000)" name="content" rows="6" placeholder="请输入文章内容">${article.content}</textarea>
                    <p id="h_content" class="help-block">请输入文章内容（字数限制20000字）</p>
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-md-12">
                    <input type="submit" class="btn btn-success btn-lg" value="修改文章">
                  </div>
                </div>
              </form>
            </div>
